import{_ as n}from"./plugin-vue_export-helper-DlAUqK2U.js";import{c as i,e as l,o as a}from"./app-BKpU7bT8.js";const e={};function d(p,s){return a(),i("div",null,s[0]||(s[0]=[l(`<h1 id="算法设计与分析作业2" tabindex="-1"><a class="header-anchor" href="#算法设计与分析作业2"><span>算法设计与分析作业2</span></a></h1><h1 id="_1-binary-search" tabindex="-1"><a class="header-anchor" href="#_1-binary-search"><span>1. binary search</span></a></h1><div class="language-text line-numbers-mode has-collapsed-lines collapsed" data-highlighter="prismjs" data-ext="text" style="--vp-collapsed-lines:15;"><pre><code class="language-text"><span class="line">FUNCTION binary_search1(arr[], low, high, x):</span>
